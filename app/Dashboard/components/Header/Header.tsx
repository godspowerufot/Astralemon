      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:block">
          <form action="#" method="POST">
            <div className="relative border-2 border-[#D1D5DB] border-solid  ">
              <button
                type="submit"
              ...
              <input
                ...
                placeholder=" search..."
                className="w-full border-3  h-9 border-gray-300 bg-transparent pl-9 pr-4 font-medium focus:outline-none xl:w-125 dark:border-strokedark"
              />
            </div>
          </form>
        </div>
