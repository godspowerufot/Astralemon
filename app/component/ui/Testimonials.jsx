  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto relative">
        ...
        <button
          className="text-indigo-500 bg-white border-2 border-indigo-500 rounded-full h-12 w-12 flex justify-center items-center absolute top-1/2 transform -translate-y-1/2 left-10"
        ...
        <button
          className="text-indigo-500 bg-white border-2 border-indigo-500 rounded-full h-12 w-12 flex justify-center items-center absolute top-1/2 transform -translate-y-1/2 right-10"
