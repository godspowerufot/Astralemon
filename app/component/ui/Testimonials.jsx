  ...
  return (
    <section className="text-gray-600 body-font" data-aos="fade-in">
      <div className="container px-5 py-24 mx-auto relative">
        <button
          className="text-indigo-500 bg-white border-2 border-indigo-500 rounded-full h-12 w-12 flex justify-center items-center absolute top-1/2 transform -translate-y-1/2 left-20 max-md:left-0"
        ...
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          ...
          <p className="leading-relaxed text-lg max-md:text-sm max-md:p-8">
          ...
          <button
            className="text-indigo-500  bg-white border-2 border-indigo-500 rounded-full h-12 w-12 flex justify-center items-center absolute top-1/2 transform -translate-y-1/2 right-20 max-md:right-0"
